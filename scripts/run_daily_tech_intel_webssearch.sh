#!/bin/bash
# ================================================================================
# 每日科技前沿资讯自动化任务 - Shell执行脚本（WebSearch增强版）
# ================================================================================
# 执行时间: 每日上午9:30 和 下午14:30
# 功能: 使用WebSearch搜索科技资讯、分析、生成报告、知识沉淀、反向信号识别
# 版本: WebSearch增强版
# ================================================================================
...
LOG_FILE="$LOG_DIR/daily_tech_intel_webssearch_${DATE}_${SESSION}.log"

# 记录开始时间
echo "========================================" >> "$LOG_FILE"
echo "🚀 科技前沿资讯自动化任务【WebSearch增强版】启动【${SESSION}】" >> "$LOG_FILE"
...
# 执行Python分析脚本（WebSearch增强版）
echo "📡 执行资讯分析（WebSearch增强版）..." >> "$LOG_FILE"
