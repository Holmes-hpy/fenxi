...
# -*- coding: utf-8 -*-
"""
2026年5月28日收盘后数据收集脚本 - 获取今日完整行情数据
"""
...
def collect_market_data():
    ...
    print("\n3️⃣ 获取热点股票...")
    try:
        result = ths_hot_reason('2026-05-28')
    ...
    print("\n5️⃣ 获取龙虎榜数据...")
    try:
        result = get_dragon_tiger_board('2026-05-28')
    ...
    # 6. 获取重点个股行情
    print("\n6️⃣ 获取重点个股行情...")
    key_stocks = ['600519', '000858', '300750', '600036', '600584', '601318', '000333', '000001']
...
if __name__ == '__main__':
    ...
    # 保存数据
    output_file = '/Users/houpengyuan/Documents/trae_projects/a-stock-data/reports/收盘后数据收集_2026-05-28.json'
