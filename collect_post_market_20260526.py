...
# -*- coding: utf-8 -*-
"""
2026年5月26日收盘后数据收集脚本 - 获取今日完整行情数据
"""
...
def collect_market_data():
    ...
    print("\n3️⃣ 获取热点股票...")
    try:
        result = ths_hot_reason('2026-05-26')
    ...
    print("\n5️⃣ 获取龙虎榜数据...")
    try:
        result = get_dragon_tiger_board('2026-05-26')
...
if __name__ == '__main__':
    ...
    # 保存数据
    output_file = '/Users/houpengyuan/Documents/trae_projects/a-stock-data/reports/收盘后数据收集_2026-05-26.json'
