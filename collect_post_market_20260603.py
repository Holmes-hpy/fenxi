...
class PostMarketLearningSystem:
    ...
    def step5_update_knowledge_base(self):
        ...
        if market_knowledge_file.exists():
            ...
            print("  ⚠️ market_knowledge.md 不存在，跳过")
        
        # 5.2 更新行业知识
        print("\n5.2 更新行业知识...")
        industry_knowledge_file = self.knowledge_dir / 'industry_knowledge.md'
        if industry_knowledge_file.exists() and 'industry' in self.market_data:
            ...
            print("  ⚠️ industry_knowledge.md 不存在或无行业数据，跳过")
        ...
        try:
            ...
            # 这里简化处理，实际应该检查 selection_history.json
